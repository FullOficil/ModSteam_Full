...
async function registrarPagamentoNoFirebase(pagamento, produto) {
  ...
  const resultado = await lojaRef.transaction((estadoAtual) => {
    ...
    const apoiosPublicos = estado.ApoiosPublicos &&
      typeof estado.ApoiosPublicos === "object"
      ? { ...estado.ApoiosPublicos }
      : {};
    ...
    const apoioPublicoExistente = apoiosPublicos[pagamentoId] &&
      typeof apoiosPublicos[pagamentoId] === "object"
