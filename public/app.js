...
async function garantirLogin(produtoId = "") {
  ...
  try {
    // Usa popup também no celular. O antigo redirecionamento passava pelo
    // domínio firebaseapp.com e podia perder a sessão ao voltar em navegadores
    // que bloqueiam armazenamento/cookies de terceiros.
