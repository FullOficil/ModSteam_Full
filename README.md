...
Ao iniciar, o servidor detecta automaticamente uma estrutura antiga em `LojaDayZombi/LOGINS_REGISTRADOS`, mescla os dados com o nó da raiz e remove o nó antigo sem apagar contas existentes.
